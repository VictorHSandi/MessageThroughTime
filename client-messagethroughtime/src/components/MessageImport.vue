<!-- reuseable input form should connect the websocket to import a photo-->
<template>
  <div class="container">
    <div class="label">
    ...
    <button class="rectangular-button" @click="handleClick">Receive</button>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    handleClick() {
      ...
      const socket = new WebSocket("wss://api.messagethroughtime.tech");
      socket.onopen = (event) => {
